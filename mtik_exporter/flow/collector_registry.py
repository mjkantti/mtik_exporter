...
from mtik_exporter.collector.interface_collector import InterfaceCollector
...
class CollectorRegistry:
    ...
    def __init__(self, router_entry: 'RouterEntry') -> None:
        ...
        polling_interval = router_entry.config_entry.polling_interval
        self.registered_collectors: list[LoadingCollector] = []

        slow_polling_interval = router_entry.config_entry.slow_polling_interval
        router_id = router_entry.router_id

        if router_entry.config_entry.dhcp:
            self.register(DHCPCollector(router_id, polling_interval))
